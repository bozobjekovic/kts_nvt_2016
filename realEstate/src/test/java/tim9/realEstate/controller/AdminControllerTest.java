...
public class AdminControllerTest {
    ...
    /**
	 * This method should return all clerks from the
	 * database that are not approved
    ...
    public void testGetAllUnapprovedClerks() throws Exception{
    	this.mockMvc.perform(get(URL_PREFIX + "/unapproved/clerks"))
	        .andExpect(status().isOk())
	        .andExpect(content().contentType(contentType))
	        .andExpect(jsonPath("$", hasSize(DB_COUNT_UNAPPROVED)))
    ...
    /**
   	 * This method should registrate new Verifier.
   	 * Expecting all valid input fields.
   	 * Expected: method post, status CREATED, and
   	 * specified content
     * @throws Exception 
   	**/
    @Test
	 ...
	 * Expected: method post, status BAD_REQUEST, and
	 * specified content
	 * @throws Exception 
	 **/
	  @Test
	 ...
	 **/
	 ...
	 public void testAcceptClerkNullParam() throws Exception{
	    this.mockMvc.perform(put(URL_PREFIX + "/accept")
            .contentType(contentType))
            .andExpect(status().isBadRequest());
	}
	 ...
	 **/
	 ...
	 public void testDenyClerk() throws Exception{
	    this.mockMvc.perform(delete(URL_PREFIX + "/deny?id=" + DB_EXISTING_ID)
            .contentType(contentType))
            .andExpect(status().isOk());
	}
	 ...
	 **/
	 ...
	 public void testDenyClerkNullParam() throws Exception{
		 this.mockMvc.perform(delete(URL_PREFIX + "/deny")
            .contentType(contentType))
            .andExpect(status().isBadRequest());
	}
	 ...
	 * company.
	 * Expecting request to be valid, but id of user to be
	 * non existing, or maybe someone else denied approved
	 * him.
	 * Expected: method post, status NOT_FOUND
	 * @throws Exception 
	 **/
	...
	**/
	...
	public void testDenyClerkApproved() throws Exception{
	 ...
	 /**
	 * This method should test getting all inappropriate
    ...
    public void testGetAllInappropriates() throws Exception{
    	this.mockMvc.perform(get(URL_PREFIX + "/inappropriate"))
	        .andExpect(status().isOk())
	        .andExpect(content().contentType(contentType))
	        .andExpect(jsonPath("$", hasSize(DB_COUNT_INAP)))
    ...
    /**
	 * This method should test rejecting inappropriate
	 * advertisement. 
	 * Expecting request to be valid.
	 * Expected: method delete, status OK
     * @throws Exception 
	 **/
    @Test
    @Transactional
    ...
    public void testRejectInappropriate() throws Exception{
    	this.mockMvc.perform(delete(URL_PREFIX + "/inappropriate/reject?id=" + DB_EXADV_ID)
            .contentType(contentType))
            .andExpect(status().isOk());
    }
	 ...
	 * This method should test rejecting inappropriate
	 * advertisement. 
	 * Expecting request to be invalid, with request
	 * parameter null.
	 * Expected: method delete, status BAD_REQUEST
     * @throws Exception 
	 **/
    @Test
    @Transactional
    ...
    public void testRejectInappropriateNullParam() throws Exception{
    	this.mockMvc.perform(delete(URL_PREFIX + "/inappropriate/reject")
            .contentType(contentType))
            .andExpect(status().isBadRequest());
    }
	 ...
	 * This method should test rejecting inappropriate
	 * advertisement. 
	 * Expecting request to be valid, but advertisement to be
	 * non existing, or maybe someone else already rejected it.
	 * Expected: method delete, status BAD_REQUEST
     * @throws Exception 
	 **/
    @Test
    ...
    public void testRejectInappropriateInvalid() throws Exception{
    	this.mockMvc.perform(delete(URL_PREFIX + "/inappropriate/reject?id=" + DB_NONEXADV_ID)
            .contentType(contentType))
            .andExpect(status().isNotFound());
    }
    
     /**
   	 * This method should test accepting inappropriate
   	 * advertisement. 
   	 * Expecting request to be valid.
   	 * Expected: method delete, status OK
     * @throws Exception 
     ...
     public void testAcceptInappropriate() throws Exception{
       	this.mockMvc.perform(delete(URL_PREFIX + "/inappropriate/accept?id=" + DB_EXADV_ID)
               .contentType(contentType))
               .andExpect(status().isOk());
       }
     ...
     public void testAcceptInappropriateNullParam() throws Exception{
       	this.mockMvc.perform(delete(URL_PREFIX + "/inappropriate/accept")
               .contentType(contentType))
               .andExpect(status().isBadRequest());
       }
   	 ...
   	 * advertisement. 
   	 * Expecting request to be valid, but advertisement to be
   	 * non existing, or maybe someone else already accepted it.
   	 * Expected: method delete, status BAD_REQUEST
     * @throws Exception 
   	 **/
     @Test
     ...
     public void testAcceptInappropriateInvalid() throws Exception{
       	this.mockMvc.perform(delete(URL_PREFIX + "/inappropriate/accept?id=" + DB_NONEXADV_ID)
               .contentType(contentType))
               .andExpect(status().isNotFound());
       }
